 ...
 *
 * Adding an icon means importing it and adding its kebab-case name below. Keys
 * are spelled exactly as a template spells them, which is what lets
 * `app-icons.spec.ts` check the templates against this map.
 */
